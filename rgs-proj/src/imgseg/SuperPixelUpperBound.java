...
public class SuperPixelUpperBound {
	...
	public static void unaryOnly(String[] args) {
		...
		try {
			...
			List<ImageInstance> testInsts = ImageSegMain.loadFromListFile(reader, "../msrc/Test.txt", labelNames,  true);
	...
	public static SLModel runLearningUnary(List<ImageInstance> trainInsts, List<ImageInstance> testInsts, String[] labelNames, 
		...
		ImageSegFeaturizer fg = new ImageSegFeaturizer(labelNames, usePairFeat, useTernFeat);
