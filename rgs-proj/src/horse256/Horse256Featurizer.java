...
public class Horse256Featurizer  extends AbstractFeaturizer {
	...
	public Horse256Featurizer(String[] albt, boolean pairwise, boolean global) {
		alphabet = albt;
	...
	public HashMap<Integer, Double> featurize(AbstractInstance xi, AbstractOutput yi) {
		...
		Horse256Instance x = (Horse256Instance)(xi);
