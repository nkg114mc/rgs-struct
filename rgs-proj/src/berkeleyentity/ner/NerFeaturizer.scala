...
import berkeleyentity.nersearch.Conll2003NerSystem
...
class NerFeaturizer(val featureSet: Set[String],
  ...
  var dicts: Array[Counter[String]] = null;
...
object NerFeaturizer {
  ...
  // B = 0, I = 1, O = 2, E = 3, S = 4 
  val transHeadSameTag = Array.ofDim[Boolean](5, 5) // preHead, curHead
  // B-tag ==>
  transHeadSameTag(0)(0) = false; transHeadSameTag(0)(1) = true; transHeadSameTag(0)(2) = false; transHeadSameTag(0)(3) = true; transHeadSameTag(0)(4) = false;
  // I-tag ==>
  transHeadSameTag(1)(0) = false; transHeadSameTag(1)(1) = true; transHeadSameTag(1)(2) = false; transHeadSameTag(1)(3) = true; transHeadSameTag(1)(4) = false;
  // O ==>
  transHeadSameTag(2)(0) = true; transHeadSameTag(2)(1) = false; transHeadSameTag(2)(2) = true; transHeadSameTag(2)(3) = false; transHeadSameTag(2)(4) = true;
  // E-tag ==>
  transHeadSameTag(3)(0) = true; transHeadSameTag(3)(1) = false; transHeadSameTag(3)(2) = true; transHeadSameTag(3)(3) = false; transHeadSameTag(3)(4) = true;
  // S-tag ==>
  transHeadSameTag(4)(0) = true; transHeadSameTag(4)(1) = false; transHeadSameTag(4)(2) = true; transHeadSameTag(4)(3) = false; transHeadSameTag(4)(4) = true;
  
  val transHeadDiffTag = Array.ofDim[Boolean](5, 5) // preHead, curHead
  // B-tag ==>
  transHeadDiffTag(0)(0) = false; transHeadDiffTag(0)(1) = false; transHeadDiffTag(0)(2) = false; transHeadDiffTag(0)(3) = false; transHeadDiffTag(0)(4) = false;
  // I-tag ==>
  transHeadDiffTag(1)(0) = false; transHeadDiffTag(1)(1) = false; transHeadDiffTag(1)(2) = false; transHeadDiffTag(1)(3) = false; transHeadDiffTag(1)(4) = false;
  // O ==>
  transHeadDiffTag(2)(0) = true;  transHeadDiffTag(2)(1) = false; transHeadDiffTag(2)(2) = true;  transHeadDiffTag(2)(3) = false; transHeadDiffTag(2)(4) = true;
  // E-tag ==>
  transHeadDiffTag(3)(0) = true; transHeadDiffTag(3)(1) = false; transHeadDiffTag(3)(2) = true;  transHeadDiffTag(3)(3) = false; transHeadDiffTag(3)(4) = true;
  // S-tag ==>
  transHeadDiffTag(4)(0) = true;  transHeadDiffTag(4)(1) = false; transHeadDiffTag(4)(2) = true;  transHeadDiffTag(4)(3) = false; transHeadDiffTag(4)(4) = true;

/*
    // Going to I-X, we can only come from B-X or I-X
  def isLegalTransition(prevLabel: String, currLabel: String) = {
    val prevHead = getHead(prevLabel)
    val currHead = getHead(currLabel)
    val prevHeadIdx = Conll2003NerSystem.LabelSetHead.indexOf(prevHead)
    val currHeadIdx = Conll2003NerSystem.LabelSetHead.indexOf(currHead)
    // println(prevHead + " ===> " + currHead + " " + prevHeadIdx + " ---> " + currHeadIdx)
    val prevType = getType(prevLabel)
    val currType = getType(currLabel)
    val isLg = if (prevType == currType) {
      transHeadSameTag(prevHeadIdx)(currHeadIdx)
    } else {
      transHeadDiffTag(prevHeadIdx)(currHeadIdx)
    }
    
    //println(prevLabel + " ===> " + currLabel + " = " + isLg)
    isLg
  }
*/
