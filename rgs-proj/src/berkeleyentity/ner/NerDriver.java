 ...
 * berkeleyentity.preprocess.PreprocessingDriver
 * 
...
public class NerDriver implements Runnable {
  ...
  public static String brownClustersPath = "data/bllip-clusters";
  ...
  // by Chao
  @Option(gloss = "Number of segments in Structure Regularization")
  public static double Alpha = 3.0; // No. of segments
