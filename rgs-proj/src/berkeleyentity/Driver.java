...
import berkeleyentity.coref.CorefPrunerJavaHack;
 ...
 * database for your test set. See berkeleyentity.wiki.WikipediaInterface
 ...
 * in berkeleyentity.ner.NerDriver to train NER mask models. Alternatively,
...
public class Driver implements Runnable {
  ...
  public static String numberGenderDataPath = "../coref/berkfiles/data/gender.data";
  ...
  public static String brownPath = "../coref/berkfiles/data/bllip-clusters";
  @Option(gloss = "Path to CoNLL evaluation script")
  //public static String conllEvalScriptPath = "../coref/reference-coreference-scorers/scorer.pl";
  public static String conllEvalScriptPath = "../coref/scorer/v7/scorer.pl";
  ...
  @Option(gloss = "Path for our result output in conll format")
  public static String myoutputPath = "myoutput";
  @Option(gloss = "Path for our wikification result output in conll format")
  public static String myoutputWikiPath = "myoutput_wiki";
  @Option(gloss = "number of docs for starting self-training")
  public static int selfTrainStartDocNumber = 30;
  
  
  @Option(gloss = "Learning rate")
  public static double structPercptronEta = 0.1;
  @Option(gloss = "number of iterations for structural perceptron")
  public static int nSpIteration = 20;
  @Option(gloss = "my model name")
  public static String myjModelPath = "./w_joint_model.ser.gz";
  ...
  //public static int lexicalFeatCutoff = 100;
  ...
  public static enum Mode {
    ...
    MAKE_MASK_MODELS, SELF_TRAIN_NAIVE, COREF_PREDICT_ACE_ILP,
    PREDICT_ACE_ILP, TRAIN_ACE_JOINTONLY_ILP;
  }
