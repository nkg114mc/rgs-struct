...
import berkeleyentity.ConllDocJustWords;
 ...
 * 
 * Sentence-splitting: Binary classifier after Gillick (2009) (berkeleyentity.preprocess.SentenceSplitter)
 * 
 * Tokenization: Penn Treebank tokenizer
 * 
 * Parsing: Berkeley Parser
 * 
 * OPTIONAL NER system: CRF-based NER system (berkeleyentity.ner.NerDriver)
 * 
 * To run this using the pretrained models, run:
 * java -cp /path/to/jar -Xmx8g berkeleyentity.preprocess.PreprocessingDriver ++base.conf \
 ...
 * 
 * Look in berkeleyentity.ner.NerDriver and
