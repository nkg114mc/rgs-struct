...
public class HwFactorGraph extends AbstractFactorGraph {
	...
	public HwFactorGraph(AbstractInstance insti, AbstractFeaturizer ftzri) {
		init((HwInstance)insti, (HwFeaturizer)ftzri);
	}
	
	public HwFactorGraph(HwInstance inst, HwFeaturizer ftzr) {
		init(inst, ftzr);
	}
	
	private void init(HwInstance inst, HwFeaturizer ftzr) {
		int i;
